...
FACE_DB_PATH = os.environ.get("FACE_DB_PATH", "data/embeddings/db.pkl")
VOTE_WINDOW = 2
VOTE_RATIO = 1.0
SKIP_FRAMES = 4
TRACKER_TIMEOUT = 6.0
...
NATIVE_CAMERA_RECOGNITION_INTERVAL = 0.20
NATIVE_DASHBOARD_REFRESH_SECONDS = 2.0
LIVENESS_ENABLED = _env_bool("LIVENESS_ENABLED", True)
...
PAD_SPOOF_THRESHOLD = _env_float("PAD_SPOOF_THRESHOLD", 0.35)
PAD_LIVE_THRESHOLD = _env_float("PAD_LIVE_THRESHOLD", 0.70)
PAD_CLEAR_LIVE_THRESHOLD = _env_float("PAD_CLEAR_LIVE_THRESHOLD", 0.90)
PAD_CLEAR_LIVE_MAX_SPOOF = _env_float("PAD_CLEAR_LIVE_MAX_SPOOF", 0.15)
PAD_CLEAR_SPOOF_THRESHOLD = _env_float("PAD_CLEAR_SPOOF_THRESHOLD", 0.80)
PAD_VOTING_WINDOW = _env_int("PAD_VOTING_WINDOW", 3)
